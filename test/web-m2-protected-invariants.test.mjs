...
const protectedFileHashes = {
  ...
  "../COMMERCIAL_ALIGNMENT_V8_17_24.md": "4D4CE1C89BDB88620D88FE6B0ED1A2789C22764135DAF9009848AA779CB0AFC7",
  ...
  "./web-m1-protected-invariants.test.mjs": "E4CC2BAF463C96FF4108AAB727433B272A8A894AD9C8EAE1C8AB9C569C473112",
...
test("Analytics contacto encabezado legal y wrappers TIA conservan sus bloques", () => {
  for (const [source, startMarker, endMarker, expectedHash] of [
    ...
    [complianceSource, "const legalContent = {", "function ContactLine(", "A8B29BBB82993F194C799E2F864FD8C41666CE3E6654EC367507AA1FF2E9D1D4"],
  ]) {
