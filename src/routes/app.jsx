...
const appTrustMetrics = [
  ...
  { icon: "ShieldCheck", title: "Diagnóstico con evidencia", text: "Síntomas, LEDs y verificaciones ordenados antes de intervenir." },
    ...
    <div className="app-pro-page">
      ...
      <section className="app-pro-positioning-section" aria-labelledby="app-pro-positioning-title">
        <div className="mock-home-container">
          ...
          <div className="app-pro-positioning-route" role="group" aria-label="Recorrido desde el síntoma hasta la decisión técnica">
