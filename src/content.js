...
export const s7Course = {
  ...
  includes: [
    "Material técnico descargable en PDF con acceso permanente",
    ...
    "Actualizaciones futuras del material técnico incluidas sin costo",
  ...
  modules: [
    ...
    "Método BOJ y uso de BOJ S7-PLC PRO",
  ],
  benefits: [
