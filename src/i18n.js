...
export const englishApp = {
  ...
  faq: [
    ...
    { question: "Which plans include the course?", answer: "The Course + 1-month PRO App bundle, Professional and Business include permanent access to the S7-300/400 diagnostics course. The Monthly subscription and One-time monthly license include the PRO App only." },
...
export const portugueseApp = {
  ...
  faq: [
    ...
    { question: "Quais planos incluem o curso?", answer: "O pacote Curso + App PRO por 1 mês, Profissional e Empresarial incluem acesso permanente ao curso de diagnóstico S7-300/400. A Assinatura Mensal e a licença mensal avulsa incluem somente o App PRO." },
