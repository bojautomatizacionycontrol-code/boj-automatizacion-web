...
// Tres páginas B2B localizadas se suman a la matriz existente; conservar el límite por documento.
export const SSR_HTML_MATRIX_BUDGET = Object.freeze({ raw: 1_480_000, gzip: 320_000 });
